...
rootRef.on("child_added",snap => {
  ...
  //  console.log("Name array=> "+name);
   ...
   // console.log("price="+price);
    ...
    $("#tid").append("<div style='margin-top:30px;margin-bottom:30px;'><div class='menu-item-name'>" +name+"</div><div class='menu-item-price'>" +price+"</div><div class='box'><input type='number' min='0' id='id"+id+"Count'class='input-text qty text' value=0> </div><div class='box1'><button class='button1' onClick='addToCart()'>Add</button></div></div>");
...
cold_coffee_ref.on("child_added",snap => {
  ...
  //  console.log("Name array=> "+name);
   ...
   // console.log("price="+price);
    ...
    $("#tid1").append("<div style='margin-top:30px;margin-bottom:30px;'><div class='menu-item-name'>" +name1+"</div><div class='menu-item-price'>" +price1+ "</div><div class='box'><input type='number' id='id"+id1+"Count' value=0> </div><div class='box1'><button class='button1' onClick='addToCart1()'>Add</button> </div></div>");
