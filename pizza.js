 ...
 */
  ...
  var rootRef = firebase.database().ref().child("largepizza");
var name;
var price;
var id;
...
rootRef.on("child_added",snap => {
  ...
  //  console.log("Name array=> "+name);
   ...
   // console.log("price="+price);
    ...
    $("#tid2").append("<div style='margin-top:30px;margin-bottom:30px;'><div class='menu-item-name'>" +name+"</div><div class='menu-item-price'>" +price+"</div><div class='box'><input type='number' id='id"+id+"Count' value=0> </div><div class='box1'><button class='button1' onClick='addToCart()'>Add</button></div></div>");
    
});
  

var cold_coffee_ref = firebase.database().ref().child("mediumpizza");
var name1;
var price1;
var id1;
...
cold_coffee_ref.on("child_added",snap => {
  ...
  //  console.log("Name array=> "+name);
   ...
   // console.log("price="+price);
    ...
    $("#tid3").append("<div style='margin-top:30px;margin-bottom:30px;'><div class='menu-item-name'>" +name1+"</div><div class='menu-item-price'>" +price1+ "</div><div class='box'><input type='number' id='id"+id1+"Count' value=0> </div><div class='box1'><button class='button1' onClick='addToCart1()'>Add</button> </div></div>");
...
function addToCart(){
 ...
 var rootRef1 = firebase.database().ref().child("largepizza");
...
function addToCart1(){
 ...
 var orders=[];
  var order={};
 var user=window.localStorage.getItem("name");
 var rootRef1 = firebase.database().ref().child("mediumpizza");
