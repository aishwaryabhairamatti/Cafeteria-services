 ...
 */
  ...
  var rootRef = firebase.database().ref().child("beverages");
var name;
var price;
var id;
...
rootRef.on("child_added",snap => {
  ...
  //  console.log("Name array=> "+name);
   ...
   // console.log("price="+price);
    ...
    $("#tid6").append("<div style='margin-top:30px;margin-bottom:30px;'><div class='menu-item-name'>" +name+"</div><div class='menu-item-price'>" +price+"</div><div class='box'><input type='number' id='id"+id+"Count' value=0> </div><div class='box1'><button class='button1' onClick='addToCart()'>Add</button></div></div>");
...
function addToCart(){
 ...
 var rootRef1 = firebase.database().ref().child("beverages");
